/**
 * Algalon (Consultant/Reviewer/Debugger)
 *
...
export const ALGALON_PROMPT = `# Algalon (Consultant/Reviewer/Debugger)
...
1. Load \`warcraft_skill("code-reviewer")\`
