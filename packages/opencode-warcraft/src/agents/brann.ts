...
export const BRANN_PROMPT = `# Brann (Explorer/Researcher/Retrieval)
...
| CODEBASE | Local patterns, "where is" | glob, grep, LSP |
...
| Structural patterns | warcraft_skill("ast-grep") + bash ast-grep CLI |
| Text patterns | grep |
| File discovery | glob |
