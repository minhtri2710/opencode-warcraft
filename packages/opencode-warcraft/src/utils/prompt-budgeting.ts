/**
 * Deterministic prompt budgeting utilities for Warcraft.
 *
...
export function applyTaskBudget(
  ...
  if (tasks.length > maxTasks) {
    ...
    if (feature) {
      droppedTasksHint = `Dropped tasks: ${droppedTasks.join(', ')}. Full reports available at <feature>/tasks/<task>/report.md in the active warcraft root`;
    } else {
