...
import { createOpencodeClient, createOpencodeServer, type Config as OpencodeConfig } from '@opencode-ai/sdk';
      ...
      try {
        ...
        try {
          promptResult = await client.session.prompt({
            ...
            body: {
              model: defaultModel,
              system: 'Call the tool warcraft_feature_create exactly once with {"name":"rt-feature"}.',
              tools: {
