...
- Latest direction in progress: if we keep seeing recovery friction here, the next step is improving structured error/hint payloads for blocked promotion steps rather than adding more workflow branches.
