...
- Latest direction in progress: if incomplete approvals still happen in practice, the next step is tightening `warcraft_plan_approve` itself so it warns or blocks when draft plans still leave unmatched manual tasks outside the reviewed plan.
